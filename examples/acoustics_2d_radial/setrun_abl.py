...
#------------------------------
    ...
    # -------------------------
    abldata = clawdata.abldata
    # Select grid mapping for layer
    #   'trigonometric', 'appelo_colonius', 'petersson_sjogreen', user defined #
    abldata.abltype = 'trigonometric'
    # Set depth of layer at each computation boundary
    abldata.depth_lower[0] = 0.2
    abldata.depth_upper[0] = 0.2
    abldata.depth_lower[1] = 0.2
    ...
    #   3) petterson_sjogreen - epsilon (e.g. {'epsilon': 1e-4})
    abldata.parameters = {}
